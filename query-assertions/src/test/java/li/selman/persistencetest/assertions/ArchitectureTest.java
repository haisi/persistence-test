...
@AnalyzeClasses(packages = "li.selman.persistencetest.assertions", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {

    private static final String ROOT_PACKAGE = "li.selman.persistencetest.assertions";
