...
@AnalyzeClasses(packages = "li.selman.persistencetest.analysis", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {

    private static final String ROOT_PACKAGE = "li.selman.persistencetest.analysis";
